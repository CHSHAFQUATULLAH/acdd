...
def fetch_diseases():
    diseases = [
        {"name": "Coffee_healthy", "image_path": "median_0_filtered.jpg", "info": [
        ...
        {"name": "Olive_Healthy", "image_path": "images.jpeg",
            "info": ["**Symptoms:** No visible symptoms; plant appears healthy.", "**Best-suited Medicine:** No treatment required."]},
        {"name": "Tomato_healthy", "image_path": "360_F_423006610_ZmVNWp8RYRi7ZqOyUKSc5AJnnFIFy7SN.jpg",
            "info": ["**Symptoms:** No visible symptoms; plant appears healthy.", "**Best-suited Medicine:** No treatment required."]},
        {"name": "Olive_peacockspot", "image_path": "images (1).jpeg", "info": [
        ...
        {"name": "Tomato_late_blight", "image_path": "images (2).jpeg",
        ...
        {"name": "Tomato_septoria_leaf_spot", "image_path": "images (3).jpeg",
        ...
        {"name": "Tomato_spider_mites", "image_path": "images (4).jpeg", "info": [
        ...
        {"name": "Wheat_brown_rust", "image_path": "images (5).jpeg", "info": [
        ...
        {"name": "Wheat_healthy", "image_path": "images (6).jpeg", "info": [
            "**Symptoms:** No visible symptoms; plant appears healthy.", "**Best-suited Medicine:** No treatment required."]},
        {"name": "Tomato_bacterial_spot", "image_path": "images (7).jpeg",
        ...
        {"name": "Tomato_leaf_mold", "image_path": "images (8).jpeg",
        ...
        {"name": "Cotton_healthy", "image_path": "original.jpg", "info": [
            "**Symptoms:** No visible symptoms; plant appears healthy.", "**Best-suited Medicine:** No treatment required."]},
        {"name": "Cucumber_Blight", "image_path": "cucumber-blight.jpg", "info": [
...
def crop_disease_detection_app():
    ...
    menu_options = ["Home", "News", "Disease Library",
                    "Disease Diagnosis", "Contact",  "About Us"]
    button_styles = {
        "Home": "primary",
        "Disease Diagnosis": "primary",
        "News": "primary",
    ...
    if selected_option == "Home":
        ...
        st.markdown("""
        - **Step 1:**  Goto Disease Diagnosis page and clik on browse image and select image of crop you want to chek.
        ...
        st.markdown("""                   
            This section provides helpful tips for using our app to its full potential and ensure accurate disease detection for your crops.
            
        - **Supported Crops:** Our app currently focuses on six key crops: coffee, olive, cotton, wheat, cucumber, and tomato comprising of 32 diseases.                       
        - **Diagnosis Available:** Currently diagnosis available for 32 diseases for more information visit disease library section.        
        - **Focus on Disease Symptoms:** Upload clear images showcasing the affected areas of your plant. Close-up shots are ideal for highlighting specific symptoms.        
        - **Lighting Matters:** Choose well-lit environments to avoid blurry or unclear photos.         
        - **Image Size:**  Don't worry about resizing! The app automatically scales your uploaded images to the optimal size (640x640 pixels) for processing.         
        - **Disease Diagnosis:** For Particular disease treatment visit Disease Library Section.
        ...
        You can also check our Disease Library page for a precise description about the disease and the best
